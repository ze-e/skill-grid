  ...
  levels: [
    ...
    },
    {
      ...
      quests: [
        ...
        },
        {
          ...
          parents: ["0166b45e-9b46-413e-951c-e4a8b0932c59"],
          descendants: [
            "e74ded8c-029b-4799-89fe-283e1611e361",
            "bdb072ee-c06d-4810-8038-7b57217530dc",
          ],
          // color goes here
        },
      ],
    },
    {
      quests: [
        {
          name: "Defender",
          skills: ["Using step movement", "Using clones", "Using buffers"],
...
export const userData = [
  {
    data: {
      ...
      food: "sushi",
      description:
        "An elite elf hacker, Rex surfs the cyberworld looking for new vulnerabilities to exploit",
    },
    admin: {
      // private data
      userName: "rex",
