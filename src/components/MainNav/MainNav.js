  ...
  return (
    <nav className={`mainNav ${gearPage && 'mainNav--gear'}` }>
      ...
      <ul className='mainNav__items'>
          <li className='mainNav__item'><NavLink className={`mainNav__link m-navLink ${(isActive) => isActive && 'active'}`} to="./gear/inventory"> <button className='m-button'>Inventory </button></NavLink></li>
          <li className='mainNav__item'><NavLink className={`mainNav__link m-navLink ${(isActive) => isActive && 'active'}`} to="./gear/store"> <button className='m-button'>Store </button></NavLink></li>
        </ul>)
      }
      <ul className='mainNav__items '>
